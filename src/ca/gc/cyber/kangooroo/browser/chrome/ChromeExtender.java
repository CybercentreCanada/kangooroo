...
public class ChromeExtender {
    ...
    /**
     * Give an element (p, a, body, ..) and it returns the font used for all the elements found Used while testing issue#22 Keeping it as it may be used to know if the font created by moose#194 is
     * properly installed
     */
